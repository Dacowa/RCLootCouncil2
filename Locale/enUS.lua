...
L["chat_commands_ffa"]		= "Start a Free-For-All roll session for an item, ignoring the priority cap, e.g. '/rc ffa [item link]'"
L["chat_commands_priority"]	= "Manually set a player's priority value, e.g. '/rc priority Playername 100'"
L["Usage: /rc ffa <item link>"] = "Usage: /rc ffa <item link>"
