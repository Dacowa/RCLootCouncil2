...
L["chat_commands_config"]	= "Open the options interface (alt. 'c', 'options', 'opt')"
...
L["chat_commands_ffa"]		= "Start a Free-For-All roll session for one or more items, ignoring the priority cap, e.g. '/rc ffa [item link] [item link] ...'"
L["chat_commands_priority"]	= "Manually set a player's priority value, e.g. '/rc priority Playername 100'"
L["Usage: /rc ffa <item link>"] = "Usage: /rc ffa <item link> [item link] ..."
L["Only the Master Looter can reset the loot ID"] = "Only the Master Looter can reset the loot ID"
L["Only the Master Looter can start a Free-For-All roll"] = "Only the Master Looter can start a Free-For-All roll"
L["Free-For-All roll announcement"] = "Free-For-All! This loot is unclaimed, /roll for it!"
L["Free-For-All roll announcement with item"] = "Free-For-All! %s is unclaimed, /roll for it!"
L["Only the Master Looter can set player priority"] = "Only the Master Looter can set player priority"
L["Usage: /rc priority <player> <value>"] = "Usage: /rc priority <player> <value>"
L["Set priority for player to value"] = "Set priority for %s to %d"
