...
L.opt_saveSessionResponses_desc = "Check to store everyone's response to items you award as Master Looter in the loot history, viewable through the history's dice button. This will increase the storage used by the loot history."
